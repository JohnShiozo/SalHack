...
public class BaseTracerModule extends Module {
   public static Value tracePortal = new Value("TracePortal", new String[]{"TP"}, "Traces portals.", true);
   public static Value traceChests = new Value("TraceChests", new String[]{"TC"}, "Traces chests.", true);
   @EventHandler
   private Listener onRender = new Listener((event) -> {
