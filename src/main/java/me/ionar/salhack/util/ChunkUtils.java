...
public class ChunkUtils {
      ...
      for(int var5 = 0; var5 < var4; ++var5) {
         ...
         if (f.getType().equals(typeOfField)) {
            try {
               ...
               throw new RuntimeException("WorldDownloader: Couldn't steal Field of type \"" + typeOfField + "\" from class \"" + typeOfClass + "\" !", var8);
            }
         }
      }
   ...
   public static Object stealAndGetField(Object object, Class typeOfField) {
      ...
      try {
         ...
         throw new RuntimeException("WorldDownloader: Couldn't get Field of type \"" + typeOfField + "\" from object \"" + object + "\" !", var4);
      }
   }
   ...
   public static void stealAndSetField(Object object, Class typeOfField, Object value) {
      ...
      try {
         ...
         throw new RuntimeException("WorldDownloader: Couldn't set Field of type \"" + typeOfField + "\" from object \"" + object + "\" to " + value + "!", var5);
      }
   }

   public static Object stealAndGetField(Object object, Class typeOfObject, Class typeOfField) {
      try {
         Field f = stealField(typeOfObject, typeOfField);
         return typeOfField.cast(f.get(object));
      } catch (Exception var4) {
